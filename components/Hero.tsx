...
export function Hero({ onScroll }: HeroProps) {
  return (
    <section
      id="home"
      className="section-shell flex min-h-screen items-center overflow-hidden pt-32 sm:pt-36"
    >
      ...
      <div className="section-wrap relative z-10 grid items-center gap-10 lg:grid-cols-[1.08fr_0.92fr]">
        <div className="animate-fadeInUp">
          ...
          <p className="mt-6 max-w-2xl text-base leading-relaxed text-foreground/72 sm:text-xl">
            {profile.title} focused on crafting responsive, performant products
            that feel polished and intuitive from first click to final
            interaction.
          </p>
        ...
        <div className="animate-slideInRight glass-panel hover-glow p-7 sm:p-8">
          ...
          <p className="mt-4 text-foreground/72">
            I care about performance, maintainability, and collaboration. The
            goal is always simple: deliver an experience users enjoy and teams
            can scale.
          </p>
        </div>
      </div>
